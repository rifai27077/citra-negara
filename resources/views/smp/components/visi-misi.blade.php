  ...
  <div class="max-w-7xl mx-auto relative z-10">
    <div class="text-center mb-14">
      <h3 class="text-3xl md:text-4xl font-extrabold text-white leading-snug">
        Visi & Misi <br />
        <!-- <span class="text-[#E9DC00] drop-shadow-[0_2px_6px_rgba(233,220,0,0.6)]">SMP Citra Negara</span> -->
        </h3>
    ...
    <div class="grid md:grid-cols-2 gap-10">
      ...
      <div class="relative group bg-white rounded-3xl p-8 shadow-lg transition-all duration-500 hover:shadow-2xl hover:-translate-y-3" data-aos="zoom-in" data-aos-delay="200">
        ...
        <p class="text-gray-700 text-base md:text-lg space-y-2 leading-relaxed relative z-10 pl-6">
          Mewujudkan peserta didik yang beperilaku baik, patuh, dan memiliki jiwa kepemimpina
        </p>
      </div>
    </div>
  </div>
