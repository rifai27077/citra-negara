<section id="visi-misi"
  class="relative min-h-[600px] py-24 px-6 bg-gradient-to-b from-[#6BAE18] to-[#5C8F14] overflow-hidden scroll-mt-24"
  ...
  <div class="max-w-7xl mx-auto relative z-10">
    <div class="text-center mb-14">
      ...
      <p class="text-white/90 text-base md:text-lg mt-5 max-w-4xl mx-auto leading-relaxed">
        Menjadi lembaga pendidikan kejuruan unggul, berlandaskan nilai religius dan karakter bangsa, serta siap
    ...
    <div class="grid md:grid-cols-2 gap-10">
      <div
        class="relative group bg-white rounded-3xl p-8 shadow-lg transition-all duration-500 hover:shadow-2xl hover:-translate-y-3"
        data-aos="zoom-in" data-aos-delay="100">
        <div
          class="absolute inset-0 rounded-3xl bg-gradient-to-br from-[#7CB518]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700">
        </div>

        <div class="flex items-center mb-6 relative">
          <div
            class="flex items-center justify-center h-14 w-14 mr-4 rounded-full bg-[#699D15] shadow-[0_0_15px_rgba(105,157,21,0.4)] transition-transform duration-500 group-hover:scale-110">
      ...
      <div
        ...
        <div
          class="absolute inset-0 rounded-3xl bg-gradient-to-br from-[#E9DC00]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700">
        </div>

        <div class="flex items-center mb-6 relative">
          <div
            class="flex items-center justify-center h-14 w-14 mr-4 rounded-full bg-[#E9DC00] shadow-[0_0_15px_rgba(233,220,0,0.5)] transition-transform duration-500 group-hover:scale-110">
