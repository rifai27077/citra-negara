<section class="py-20 min-h-[600px] px-6 bg-white" id="ekstrakurikuler">
  <div class="max-w-7xl mx-auto text-center mb-14">
    <h2 class="text-4xl md:text-5xl font-extrabold text-gray-800 mb-4">
      <span class="text-[#7CB518]">Ekstrakurikuler</span> SMP Citra Negara
    </h2>
  </div>

  @php
    $ekskul = [
      ['nama'=>'Paskibra','deskripsi'=>'Pasukan Pengibar Bendera SMP Citra Negara yang melatih kedisiplinan dan tanggung jawab.','img'=>'/images/smp/paskib.jpg','wa'=>'#','ig'=>'https://www.instagram.com/ra.gara_46','posisi'=>'left'],
      ['nama'=>'Tari','deskripsi'=>'Ekstrakurikuler tari yang menumbuhkan rasa cinta seni dan budaya.','img'=>'/images/smp/tari.jpg','wa'=>'#','ig'=>'https://www.instagram.com/tarismpcitranegara','posisi'=>'right'],
      ['nama'=>'Taekwondo','deskripsi'=>'Seni bela diri Taekwondo untuk melatih fisik, mental, dan kepercayaan diri siswa.','img'=>'/images/smp/taekwondo.jpg','wa'=>'#','ig'=>'https://www.instagram.com/taekwondo_satjaycitranegara','posisi'=>'left'],
      ['nama'=>'Hadroh','deskripsi'=>'Seni musik islami yang membentuk karakter religius dan kreatif siswa.','img'=>'/images/smp/hadroh.jpg','wa'=>'#','ig'=>'https://www.instagram.com/hadroh_smp_cn','posisi'=>'right'],
      ['nama'=>'Pramuka','deskripsi'=>'Kegiatan kepanduan yang menanamkan nilai kedisiplinan, kebersamaan, dan tanggung jawab.','img'=>'/images/smp/pramuka.jpg','wa'=>'#','ig'=>'https://www.instagram.com/pramukacitranegara','posisi'=>'left'],
      ['nama'=>'Futsal','deskripsi'=>'Kegiatan olahraga futsal untuk mengembangkan sportivitas dan kerja sama tim.','img'=>'/images/smp/futsal.jpg','wa'=>'#','ig'=>'https://www.instagram.com/futsal.smpcitranegara/','posisi'=>'right'],
      ['nama'=>'Basket','deskripsi'=>'Ekstrakurikuler basket yang melatih kerja tim dan semangat juang.','img'=>'/images/smp//basket.jpg','wa'=>'#','ig'=>'https://www.instagram.com/b2cn_','posisi'=>'left'],
    ];
  @endphp
