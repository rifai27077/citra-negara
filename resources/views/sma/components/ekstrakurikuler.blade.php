<section class="py-20 min-h-[600px] px-6 bg-white" id="ekstrakurikuler">
  ...
  @php
    $ekskul = [
      ['nama'=>'CITTER','deskripsi'=>'Citra Negara Theater','img'=>'/images/sma/citter.png','wa'=>'#','ig'=>'https://www.instagram.com/citter_','posisi'=>'left'],
      ['nama'=>'Futsal','deskripsi'=>'Ekstrakurikuler Futsal','img'=>'/images/sma/futsal.png','wa'=>'#','ig'=>'https://www.instagram.com/futsal.cn','posisi'=>'right'],
      ['nama'=>'Paskibra','deskripsi'=>'Baswara','img'=>'/images/sma/paskibra.png','wa'=>'#','ig'=>'https://www.instagram.com/paskibra.baswara','posisi'=>'left'],
      ['nama'=>'Cinar','deskripsi'=>'Seni Tari Citra Negara','img'=>'/images/sma/cinar.png','wa'=>'#','ig'=>'https://www.instagram.com/senitaricitranegara','posisi'=>'right'],
      ['nama'=>'Taekwondo','deskripsi'=>'Taekwondo Citra Negara','img'=>'/images/sma/tekon.jpg','wa'=>'#','ig'=>'https://www.instagram.com/taekwondo.satjaycitranegara','posisi'=>'left'],
      ['nama'=>'Band','deskripsi'=>'Quimica Citra Negara','img'=>'/images/sma/band.jpg','wa'=>'#','ig'=>'https://www.instagram.com/quimica_band','posisi'=>'right'],
      ['nama'=>'Basket','deskripsi'=>'Menace Basketball','img'=>'/images/sma/basket.jpg','wa'=>'#','ig'=>'https://www.instagram.com/menace.bball','posisi'=>'left'],
      ['nama'=>'Voli','deskripsi'=>'Elytra Citra Negara','img'=>'/images/sma/voli.png','wa'=>'#','ig'=>'https://www.instagram.com/volleyballcitranegara','posisi'=>'right'],
      ['nama'=>'Irma','deskripsi'=>'Ikatan Remaja Masjid (IRMA) SMK Citra Negara','img'=>'/images/sma/irma.jpg','wa'=>'#','ig'=>'https://www.instagram.com/irma_smkcitranegara','posisi'=>'left'],
    ];
  @endphp
