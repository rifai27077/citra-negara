...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-6 border-b border-gray-200">
            <h2 class="text-xl font-bold text-gray-900">Buat Berita Baru</h2>
            <p class="text-gray-500 mt-1">Tulis berita atau artikel untuk website</p>
        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="jenjang" 
                                ...
                                required>
                            <option value="umum" {{ old('jenjang') === 'umum' ? 'selected' : '' }}>Umum (Semua)</option>
                ...
                <div>
                    <label for="excerpt" class="block text-sm font-medium text-gray-700 mb-2">
                        Ringkasan
                        <span class="text-gray-400 font-normal">(Opsional, akan dibuat otomatis dari konten)</span>
                    </label>
                    <textarea name="excerpt" 
                              id="excerpt"
                              rows="2"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none resize-none @error('excerpt') border-red-500 @enderror"
                ...
                <div class="flex items-center gap-3 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div>
                        <p class="font-medium text-gray-900">Publikasikan Sekarang</p>
                        <p class="text-sm text-gray-500">Jika tidak dicentang, berita akan disimpan sebagai draft</p>
                    </div>
                </div>
            </div>
