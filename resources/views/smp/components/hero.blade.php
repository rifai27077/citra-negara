<section 
  ...
  <x-vimeo-background
    :embed-url="config('hero.smp.embed_url') ?: 'https://vimeo.com/1185481710?fl=pl&fe=sh'"
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 flex flex-col items-center justify-center min-h-[400px]" style="min-height:400px;">
    <div class="w-full md:w-2/3 mx-auto text-center" data-aos="zoom-in" data-aos-delay="50">
        <h1 class="text-3xl md:text-4xl font-extrabold text-white mb-4">
            Selamat Datang di <span class="text-[#7CB518] rounded">SMP Citra Negara</span>
        </h1>
        <p class="text-white text-lg mb-6">
            Membangun dasar ilmu, karakter, dan kreativitas peserta didik untuk menjadi generasi unggul, berakhlak, dan siap menghadapi masa depan.
        </p>
    </div>
  </div>
</section>
