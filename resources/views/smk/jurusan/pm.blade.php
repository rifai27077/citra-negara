...
<div class="bg-[#f8f8f8] text-gray-800">
  ...
  <section class="relative pt-16 flex flex-col items-center">
    <div class="max-w-6xl mx-auto px-6 text-center">
        ...
        <div class="mb-8 flex justify-center" data-aos="fade-down">
             <div class="bg-[#E26A00]/10 text-[#E26A00] border border-[#E26A00]/30 px-4 py-1.5 rounded-full text-[10px] font-black tracking-[0.2em] uppercase">
                Jurusan Unggulan
             </div>
        </div>
        ...
        <div class="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12">
            ...
            <div class="relative" data-aos="zoom-in" data-aos-delay="200">
                <div class="absolute inset-0 bg-[#E26A00]/15 blur-3xl rounded-full"></div>
                <img src="{{ asset('/images/smk/jurusan/logo-pm.png') }}" class="relative w-24 h-24 md:w-32 md:h-32 object-contain drop-shadow-2xl hover:scale-105 transition-transform duration-500">
            </div>
            
            <!-- Title with Modern Accent -->
            <div class="text-center md:text-left border-l-0 md:border-l-[6px] border-[#E26A00] md:pl-10" data-aos="fade-left" data-aos-delay="300">
                <h1 class="text-3xl md:text-5xl font-black text-gray-900 tracking-tight leading-[1.1]">
                    Pemasaran <br>
                    <span class="text-[#E26A00]">Digital & Bisnis</span>
                </h1>
                <p class="mt-4 text-gray-500 font-medium text-sm md:text-lg max-w-md mx-auto md:mx-0">
                    Kuasai strategi pasar dan kembangkan jiwa kewirausahaan untuk masa depan gemilang.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="mt-12 flex justify-center w-full relative" data-aos="fade-up" data-aos-delay="400">
      <img src="/images/smk/jurusan/ml-pm.png" loading="lazy" decoding="async" alt="model pasangan pm" class="w-full max-w-sm [mask-image:linear-gradient(to_bottom,black_80%,transparent_100%)] [-webkit-mask-image:linear-gradient(to_bottom,black_80%,transparent_100%)]">
    </div>
  </section>
    ...
    <div class="grid lg:grid-cols-12 gap-12 items-start">
      ...
      <div class="lg:col-span-7 bg-white rounded-[2.5rem] p-8 md:p-12 shadow-[0_20px_50px_rgba(0,0,0,0.03)] border border-gray-100" data-aos="fade-right">
          <div class="flex items-center gap-3 mb-6">
              <div class="w-12 h-1.5 bg-[#E26A00] rounded-full"></div>
              <span class="text-xs font-bold uppercase tracking-[0.2em] text-[#E26A00]">Strategi & Bisnis</span>
          </div>
          <h2 class="text-2xl md:text-4xl font-black mb-8 text-gray-900 leading-tight tracking-tight">
            Apa Itu Bidang Studi <br> Pemasaran Digital & Bisnis?
          </h2>
          <div class="space-y-6">
              <p class="text-gray-600 leading-relaxed text-lg text-justify border-l-4 border-gray-100 pl-6">
                Bidang studi <span class="font-bold text-gray-900 underline decoration-[#E26A00]/30">Pemasaran (PM)</span> adalah program pendidikan yang fokus pada pengembangan keterampilan dalam bidang pemasaran, riset, dan penjualan modern. 
              </p>
              <p class="text-gray-600 leading-relaxed">
                Di era digital ini, siswa diajarkan strategi E-commerce, Digital Marketing, hingga teknik negosiasi yang mempersiapkan mereka menghadapi kompetisi bisnis global yang ketat.
              </p>
          </div>
      </div>
      ...
      <div class="lg:col-span-5" data-aos="fade-left">
          <h2 class="text-2xl font-bold mb-8 flex items-center gap-4 text-gray-800">
              <div class="w-10 h-10 rounded-full bg-[#E26A00]/10 flex items-center justify-center">
                <i class="fa-solid fa-chart-line text-sm text-[#E26A00]"></i>
              </div>
              Kurikulum Strategis
          </h2>
          @php
            $materi = [
              ...
              'Riset Pasar & Analitik',
              'Strategi Branding Modern',
              'Penjualan & Teknik Negosiasi',
          ...
          <div class="grid gap-4">
            @foreach ($materi as $m)
                <div class="group flex items-center p-5 bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl hover:border-[#E26A00]/30 transition-all duration-300">
                    <div class="w-10 h-10 rounded-xl bg-gray-50 flex items-center justify-center text-gray-400 group-hover:bg-[#E26A00] group-hover:text-white transition-all duration-500">
  ...
  <section class="bg-gray-900 py-24 rounded-t-[3rem] md:rounded-t-[5rem] overflow-hidden relative">
    <div class="absolute top-0 right-0 w-96 h-96 bg-[#E26A00]/5 blur-[100px] rounded-full"></div>
    <div class="max-w-6xl mx-auto px-6 relative z-10">
        <div class="text-center mb-20" data-aos="fade-up">
            <h2 class="text-3xl md:text-5xl font-black text-white mb-6">Peluang Karir Bisnis</h2>
            <div class="w-20 h-1.5 bg-[#E26A00] mx-auto rounded-full mb-6"></div>
            <p class="text-gray-400 text-lg max-w-2xl mx-auto">Masuki dunia bisnis yang profesional dengan keahlian pemasaran yang matang dan strategi penjualan yang teruji.</p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            @foreach ($career as $job)
                <div class="bg-white/5 border border-white/10 p-8 rounded-[2rem] hover:bg-[#E26A00] group transition-all duration-500 cursor-default" data-aos="zoom-in">
                    <div class="w-12 h-12 bg-white/10 rounded-2xl flex items-center justify-center text-[#E26A00] group-hover:bg-black/10 group-hover:text-white mb-6 transition-all">
                    ...
                    <p class="mt-3 text-gray-500 group-hover:text-white/80 text-sm opacity-0 group-hover:opacity-100 transition-all">Siap menjadi penggerak ekonomi di industri global.</p>
                </div>
            @endforeach
        </div>
    </div>
  ...
  <section class="bg-gray-50 py-24 border-t border-gray-100">
    <div class="max-w-6xl mx-auto px-6 text-center">
      ...
      <div class="w-12 h-1.5 bg-[#E26A00] mx-auto rounded-full mb-4"></div>
